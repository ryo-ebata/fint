...
mod tests {
    ...
    fn test_new() {
        ...
        assert_eq!(Int::new(4000000000u64), Int::U64(4000000000)); // Add type annotation
        assert_eq!(Int::new(10000000000000000000u128), Int::U128(10000000000000000000)); // Add type annotation
    }
}
